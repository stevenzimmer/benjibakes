...
function QuantityButton({
  ...
  return (
    <button
      ...
      } bg-white border border-bb-brown-20 p-2 rounded-full transition-colors disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:bg-white disabled:hover:text-inherit`}
      onClick={() => onClick(i)}
