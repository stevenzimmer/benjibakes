...
export default function CheckoutBreadCrumbs() {
  ...
  const steps = [
    ...
    { key: "confirmOrder", label: "Confirm", canGo: canProceedToCheckout },
  ];

  const normalizedState =
    checkoutState === "checkout" ? "confirmOrder" : checkoutState;
  const currentIndex = steps.findIndex((step) => step.key === normalizedState);
