...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-[32px] border border-bb-brown-20 bg-white/80 p-3 md:px-10 lg:px-12">
      ...
      <div className="relative grid gap-4 lg:gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full bg-bb-brown-10 px-4 py-2 text-xs md:text-sm font-semibold text-bb-brown">
            <Sparkles size={16} />
            Seasonal treats • Baked to order • Rocklin / Roseville, Ca
          </div>
          ...
          <p className="mt-4 text-lg md:text-xl text-bb-brown/80 max-w-xl">
            Benji Bakes is your local cookie counter in Rocklin and Roseville
            for seasonal favorites and crowd-pleasers. Order online and pick up
          ...
          <div className="mt-6 grid grid-cols-2 gap-4 text-sm md:text-base">
            <div className="rounded-2xl bg-white/80 border border-bb-brown-20 p-4">
              <p className="font-semibold text-bb-ink">Pickup window</p>
              <p className="text-bb-brown/80">3:00–6:00 PM</p>
            </div>
            <div className="rounded-2xl bg-white/80 border border-bb-brown-20 p-4">
              <p className="font-semibold text-bb-ink">Seasonal menu</p>
              <p className="text-bb-brown/80">New cookies monthly</p>
            </div>
          </div>
        </div>
