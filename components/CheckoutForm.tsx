...
export default function CheckoutForm({
  ...
  const { setCheckoutError, checkoutError, setShowSidebar, setCheckoutState } =
        ...
        <div className="space-y-4">
              ...
              {cartStore.cart.map((item, idx) => (
                ...
                >
                  <span className="text-bb-brown">
                    {item.quantity} × {item.title} ({item.number})
                  </span>
          ...
          <div className="rounded-2xl border border-bb-brown-20 bg-white/90 p-5 text-sm md:text-base text-bb-brown">
            <p className="mb-2">
              ...
              order details and receipt. We&apos;ll also follow up to coordinate
              pickup time.
            </p>
            {/* <BakeryAddress /> */}
          </div>
