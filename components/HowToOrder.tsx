        ...
        <div className="space-y-8">
            ...
            {[
              {
                ...
                body: "Pick seasonal favorites from our menu and build your box.",
              },
              {
                title: "Review your cart",
                body: "Adjust quantities, then confirm your order details.",
              },
              {
                title: "Add your info",
                body: "Share your name, email, and select a pickup date.",
              },
              {
                title: "Pay online",
                body: "Checkout securely. We’ll email your receipt instantly.",
              },
            ].map((step, index) => (
              <div
                key={step.title}
          ...
          <div className="rounded-2xl border border-bb-brown-20 bg-bb-brown-10/70 p-6">
            <p className="text-lg md:text-xl text-bb-brown mb-4">
              After checkout, we&apos;ll send a confirmation email with your
              order details and receipt. We&apos;ll follow up to coordinate your
              pickup time.
            </p>
            {/* <BakeryAddress /> */}
          </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-2xl border border-bb-brown-20 bg-white/90 p-6">
            ...
            <p className="text-bb-brown">
              Orders are prepared fresh for your selected pickup date. Need to
              adjust timing? Just reply to your confirmation email.
            </p>
          </div>
        </div>
      </div>
