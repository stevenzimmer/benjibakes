      ...
      <div className="lg:w-1/2 mx-auto h-full flex items-center justify-center p-2 lg:p-6">
        <div className="bg-white p-2 lg:p-6 lg:px-12 w-full text-center rounded-xl shadow-lg">
          ...
          <p className="lg:text-xl">
            We are welcoming a new addition to our Benji Bakes family so we are
            pausing orders while we settle into this sweet new season.
          </p>
          <p className="lg:text-lg mt-4">
            Feel free to browse the site, but ordering is closed. Thank you for
            the support and understanding! 💛 Stay in the loop by following us
            on{" "}
            <Link
