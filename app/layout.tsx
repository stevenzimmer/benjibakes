...
export const metadata: Metadata = {
  ...
  description:
    "Benji Bakes is a local cookie bakery serving Rocklin and Roseville in Placer County, CA. Order small-batch, baked-to-order cookies for pickup, including seasonal favorites and our Brown Butter Chocolate Chip.",
  keywords: [
    "Rocklin bakery",
    "Rocklin cookies",
    "Roseville bakery",
  ...
  openGraph: {
    title: "Benji Bakes - Cookies & Bakery in Rocklin + Roseville, CA",
    description:
      "Small-batch, baked-to-order cookies for pickup in Rocklin and Roseville, Placer County, CA.",
...
const structuredData = {
  ...
  url: "https://www.benjibakes.com",
  description:
    "Benji Bakes is a local cookie bakery serving Rocklin and Roseville in Placer County, CA. Small-batch cookies are baked to order for pickup, including the Brown Butter Chocolate Chip and seasonal favorites.",
  ...
  hasMap:
    "https://www.google.com/maps/place/4535+Mountaingate+Dr,+Rocklin,+CA+95765",
  sameAs: ["https://www.instagram.com/benjibakescookies"],
