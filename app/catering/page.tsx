      ...
      <div className="flex justify-between flex-wrap">
        <div className="w-full lg:w-7/12">
          ...
          <ul className="list-disc pl-6 space-y-3 text-bb-brown">
            <li>
              <strong>Bulk cookies for large displays</strong>: Order our
              homemade cookies in bulk at a special discounted rate, perfect for
              customers looking to create their own beautiful displays for
              parties and events. Enjoy the flexibility to customize your
              dessert table while delighting guests with our incredible flavors.
            </li>
            <li>
              <strong>Individually wrapped cookies</strong>: Perfect for
              grab-and-go events or party favors. We can customize the amount of
              cookies in each bag, a custom label (i.e. Happy Birthday Benji),
              decorative ribbon, and more!
            </li>
            <li>
              <strong>Custom orders</strong>: Looking for something even more
              unique? Let us know your vision, and we’ll work together to make
              it happen!
            </li>
          </ul>
          <div className="columns-2 sm:gap-6 mt-8">
            {cookies.map((cookie, i) => (
              <div
                key={i}
                className="w-full mx-auto py-6 break-inside-avoid-column "
              >
                <Image
                  src={cookie.path}
                  alt={cookie.caption}
                  width={500}
                  height={500}
                  className="rounded-2xl border border-bb-brown-20 shadow-lg w-full object-cover"
                />
                <p className="text-center text-bb-brown mt-3 px-3 text-sm sm:text-base">
                  {cookie.caption}
                </p>
              </div>
            ))}
